    ...
    return (
      <div className="col-md-12 card">
        <div className="card-body">
          ...
          <button onClick={this.handleDelete} className="btn btn-outline-danger btn-round mt-3 pull-right">
            Delete
          </button>
          <button onClick={this.submitSelect} className="btn btn-outline-info btn-round mt-3 pull-right">
